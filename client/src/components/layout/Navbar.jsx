        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="p-2 rounded-lg text-[#17a2b8] hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-[#17a2b8]"
            >
              <svg
                className="w-5 h-5"
                fill="none"
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-3 p-2 rounded-lg hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring--[#17a2b8]"
              >
                <div className="w-8 h-8 bg-[#17a2b8] rounded-full flex items-center justify-center">
