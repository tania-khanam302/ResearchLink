...
const LoginPage = () => {
  ...
  return (
    <>
      <div className="min-h-screen  bg-[#e4f6fa]  flex items-center justify-center px-4">
        <div className="relative z-10  max-w-md w-full">
          <div className="px-6 py-6 rounded-lg border shadow-[0px_0px_40px_rgba(0,0,0,0.35)]">
            {/* login header */}
