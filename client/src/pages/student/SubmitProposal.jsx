      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/40 overflow-hidden">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-[#17a2b8] to-[#138496] px-6 sm:px-8 py-7">
          ...
          <div className="relative flex items-center gap-4">
            <div className="w-14 h-14 shrink-0 rounded-2xl bg-white/15 backdrop-blur-sm border border-white/20 flex items-center justify-center text-2xl shadow-lg">
              📝
            </div>
        ...
        >
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 shrink-0 rounded-xl flex items-center justify-center text-xl transition-all duration-200 ${
                        formData.type === item.value
            ...
            <input
              ...
              placeholder={
                formData.type === "Thesis"
                  ...
                  : "Enter your thesis and project title"
              }
              className="
                w-full
                px-4
            ...
            <textarea
              ...
              placeholder={
                formData.type === "Thesis"
                  ...
                  : "Provide a detailed description of your thesis and project..."
              }
              className="
                w-full
                min-h-[180px]
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-4 pt-6 border-t border-slate-100">
            ...
            <div className="text-sm text-slate-500">
              <span className="text-[#17a2b8] font-medium">*</span>{" "}
