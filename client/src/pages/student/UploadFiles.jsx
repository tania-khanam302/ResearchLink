...
const UploadFiles = () => {
  ...
  const handleAddResourceLink = async () => {
    ...
    try {
      ...
      toast.error(error?.message || error || "Failed to add resource link");
    }
  };
  ...
  const handleDeleteResourceLink = async (linkId) => {
    ...
    try {
      ...
      toast.error(error?.message || error || "Failed to delete resource link");
    }
  };
  ...
  const handleDownloadFile = async (file) => {
    try {
      ...
      toast.error(error?.message || error || "Download failed");
    }
  };
  ...
  const handleDeleteFile = async (file) => {
    try {
      ...
      toast.error(error?.message || error || "Failed to delete file");
    }
  };
  ...
  const resourceLinks = activeWork?.resourceLinks || [];

  const totalResourcePages = Math.ceil(
    resourceLinks.length / resourceLinksPerPage,
  );

  const resourceStartIndex = (resourceCurrentPage - 1) * resourceLinksPerPage;
  ...
  useEffect(() => {
    if (totalResourcePages > 0 && resourceCurrentPage > totalResourcePages) {
  ...
  const getResourceIcon = (type = "") => {
    ...
    if (value.includes("research") || value.includes("paper")) {
    ...
    if (value.includes("demo") || value.includes("live")) {
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1.5 text-sm text-white/80 sm:text-base">
                Upload reports, presentations, source code and supporting files
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="group rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50/60 p-6 text-center transition-all duration-300 hover:border-[#17a2b8]/50 hover:bg-white hover:shadow-lg">
              ...
              <p className="mb-5 text-sm leading-6 text-slate-500">
                Upload your final thesis or project report.
                <br />
                <span className="text-slate-400">PDF, DOC, DOCX</span>
              </p>
            ...
            <div className="group rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50/60 p-6 text-center transition-all duration-300 hover:border-[#17a2b8]/50 hover:bg-white hover:shadow-lg">
              ...
              <p className="mb-5 text-sm leading-6 text-slate-500">
                ...
                <br />
                <span className="text-slate-400">PPT, PPTX, PDF</span>
              </p>
            ...
            <div className="group rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50/60 p-6 text-center transition-all duration-300 hover:border-[#17a2b8]/50 hover:bg-white hover:shadow-lg">
              ...
              <p className="mb-5 text-sm leading-6 text-slate-500">
                Upload your source code archive.
                <br />
                <span className="text-slate-400">ZIP, RAR, TAR, GZ</span>
              </p>
            ...
            <div className="group rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50/60 p-6 text-center transition-all duration-300 hover:border-[#17a2b8]/50 hover:bg-white hover:shadow-lg">
              ...
              <p className="mb-5 text-sm leading-6 text-slate-500">
                Dataset, diagrams, documentation, etc.
                <br />
          ...
          <div className="mt-6 rounded-2xl border border-cyan-100 bg-cyan-50/60 p-5">
            ...
            <div className="mt-3 grid gap-2 text-sm text-slate-600 sm:grid-cols-2">
              ...
              <p>
                ...
                Dataset, papers, questionnaires, diagrams, documentation, etc.
              </p>
            </div>
            ...
            <div className="mt-4 rounded-xl bg-white/70 border border-cyan-100 px-4 py-3">
              <p className="text-xs sm:text-sm text-slate-500 leading-6 italic text-justify">
                ...
                Report is required. Presentation is recommended. Source Code is
                required only for projects/theses that involve programming.
                Supporting Files may include datasets, research papers,
                questionnaires, diagrams, database files, documentation,
                screenshots, or other relevant materials.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-b border-slate-100 bg-gradient-to-r from-cyan-50/70 via-white to-slate-50 px-6 py-6 sm:px-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Add important external resources related to your project or
                thesis.
              </p>
            </div>
          </div>
          ...
          {totalFiles === 0 ? (
            <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50/60 py-14 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                Your reports, presentations, source code, and supporting files
                will appear here.
              </p>
            </div>
          ) : (
          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  GitHub, research papers, Drive, live demo and other resources.
                </p>
              </div>
            </div>
            ...
            <div className="w-fit rounded-full bg-white px-4 py-2 text-sm font-semibold text-[#138496] shadow-sm ring-1 ring-cyan-100">
              ...
              {resourceLinks.length === 1 ? "Link" : "Links"}
            </div>
          </div>
        </div>
          ...
          {resourceLinks.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-cyan-200 bg-cyan-50/40 px-4 py-10 text-center">
              ...
              <p className="mt-1 text-xs text-slate-400">
                Add GitHub, Research Paper, Google Drive, or Live Demo links
