                    ...
                    <td className="px-3 py-4">
                      <div className="flex flex-wrap gap-2">
                        ...
                        {project.status === "pending" && (
                          <>
                            <button
                              className="inline-flex items-center justify-center rounded-lg bg-green-600  px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition-all duration-200 hover:bg-green-700 hover:shadow-md active:scale-[0.98]
                            "
                              onClick={() =>
