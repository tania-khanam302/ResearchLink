            ...
            <table className="w-full text-left border-collapse overflow-x-hidden">
              <thead className="bg-slate-100">
                <tr className=" text-[#138496] text-xs font-semibold uppercase">
                  ...
                  <th className="px-6 py-5 text-left ">Department & Year</th>
              ...
              <tbody className="bg-white divide-y divide-slate-200">
                <tr className="hover:bg-slate-50">
                  ...
                  {/* extra */}
                  <td className="text-sm font-medium text-slate-900"></td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrapp"></td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <button className="text-[#17a2b8] hover:text-blue-900 pe-2">
                      Edit
                    </button>
                ...
                <div className="grid items-center mb-4">
                  ...
                  <div className="text-center ">
                    ...
                    <p className="text-sm text-slate-500 mb-4">
                      ...
                      <span>
                        Jhon? This action cannot be undone.
                      </span>
                    </p>

                    <div className="flex justify-center space-x-3">
                      <button className="btn-secondary text-white px-4 font-medium h-11 rounded-md flex items-center space-x-2 mt-4 md:mt-0 shadow-md">
                        Cancel
                      </button>
                      <button
